                                ...
                                <tbody>
                                    @forelse($data as $key => $item)
                                        ...
                                        <tr data-id="{{ $item->id }}" data-pt-id="{{ $item->pt_id }}"
                                            ...
                                            <td>
                                                {{ $item->armada->nama_armada }} - {{ $item->armada->plat_nomor ?? '-' }}
                                            </td>
                                            <td>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" name="armada_id" required>
                                    ...
                                    @foreach ($armada as $a)
                                        <option value="{{ $a->id }}">{{ $a->nama_armada }} - {{ $a->plat_nomor }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="rute_from" placeholder="Lokasi awal"
                                    required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Rute Ke <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="rute_to" placeholder="Lokasi tujuan"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" name="harga_pabrik" step="0.01" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Harga Armada <span class="text-danger">*</span></label>
                                <input type="number" class="form-control" name="harga_armada" step="0.01" required>
                            </div>
                        </div>
                ...
                <form id="formEditPengiriman" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Harga Pabrik <span class="text-danger">*</span></label>
                                <input type="number" class="form-control" name="harga_pabrik" id="edit_harga_pabrik"
                                    step="0.01" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Harga Armada <span class="text-danger">*</span></label>
                                <input type="number" class="form-control" name="harga_armada" id="edit_harga_armada"
                                    step="0.01" required>
                            </div>
                        </div>
                    </div>
